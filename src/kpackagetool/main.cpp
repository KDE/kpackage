...
int main(int argc, char **argv)
{
    ...
    parser.addOption(QCommandLineOption(QStringList() << "n" << "index", i18n("Recreate the plugin index. to be used in conjunction with either the option -t or -t. Recreates the index for the given type or package root. Operates in the user directory, unless -g is used")));
